...
// configuration step. It creates a namespace called `cmake_from_template`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_from_template::cmake::project_name, cmake_from_template::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_from_template::cmake::project_version);
      return EXIT_SUCCESS;
    }
